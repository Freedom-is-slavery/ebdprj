...
ucos-ii/port/%.o: ../ucos-ii/port/%.s
	arm-none-eabi-gcc -mcpu=cortex-m3 -g3 -c -I"C:/Users/admin/Desktop/STM32_test/ebdprj/ex8_ucos ii/ucos-ii" -x assembler-with-cpp --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
